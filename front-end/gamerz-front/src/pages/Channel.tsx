...
//                 id: Date.now().toString(), // Généré localement
//                 description: trimmedText,
//                 fromSelf,
//                 createdAt: new Date().toISOString(),
//                 sender: data.senderId,
//                 senderName: null, // à adapter si disponible
//             };
        
//             // 🧠 Ajout local pour l'affichage immédiat
//             setMessages((prev) => [...prev, newMessage]);
        
//             // ✅ Envoi au backend
//             const sendMessageToBackend = async () => {
//                 try {
//                     const response = await fetch("http://localhost:5006/messages", {
//                         method: "POST",
//                         headers: {
...
//                         body: JSON.stringify({
//                             channel: id,
//                             sender: "<userMongoId>", // ⚠️ À remplacer par l’ObjectId MongoDB réel du user
//                             description: trimmedText,
//                             // Pas besoin de createdAt si le schema Mongoose a timestamps: true
//                         }),
//                     });
...
//                     console.log("✅ Message bien enregistré en BDD");
//                 } catch (err) {
