...
let send = (message: string) => {
  ...
  let msgToSend = document.getElementById("msgToSend") as HTMLInputElement;
  console.log("Message sent: ", msgToSend.value);
  msgToSend.value = "";
};
      ...
      <div className="flex flex-col flex-auto h-full p-6">
        ...
        >
          ...
          >
            ...
            <div className="ml-4">
              <button onClick={() => send((document.getElementById("msgToSend") as HTMLInputElement)?.value)}
